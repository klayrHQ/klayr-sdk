...
import { Engine } from 'klayr-sdk';
import { chain, db as klayrdB, blockHeaderSchema, codec, BlockHeader } from 'klayr-sdk';
import { getContradictingBlockHeader, saveBlockHeaders } from '../../src/db';

describe('db', () => {
	const dbPath = 'test-klayr-framework-report-misbehavior-plugin.db';
	const db = new klayrdB.Database(dbPath);
