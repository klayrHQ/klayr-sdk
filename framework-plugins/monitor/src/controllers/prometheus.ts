			...
			const data: PrometheusData[] = [
				{
					...
					metric: 'klayr_avg_times_blocks_received_info',
					values: [
						{
							key: '',
				...
				},
				{
					...
					type: PROMETHEUS_TYPE.gauge,
					metric: 'klayr_avg_times_transactions_received_info',
					values: [
						{
							key: '',
				...
				},
				{
					label: 'Node Height',
					type: PROMETHEUS_TYPE.gauge,
					metric: 'klayr_node_height_total',
					values: [
						{
							key: '',
				...
				},
				{
					...
					type: PROMETHEUS_TYPE.gauge,
					metric: 'klayr_finalized_height_total',
					values: [
						{
							key: '',
				...
				},
				{
					...
					type: PROMETHEUS_TYPE.gauge,
					metric: 'klayr_unconfirmed_transactions_total',
					values: [
						{
							key: '',
				...
				},
				{
					label: 'Fork events',
					type: PROMETHEUS_TYPE.gauge,
					metric: 'klayr_fork_events_total',
					values: [
						{
							key: '',
