 ...
 */
import { apiClient, cryptography, passphrase, codec } from '@klayr/client';
...
const MainPage: React.FC = () => {
	...
	const generateNewAccount = () => {
		...
		const klayr32Address = cryptography.address.getKlayr32AddressFromAddress(address);
		const newAccount: Account = {
			passphrase: accountPassphrase,
			publicKey: keys.publicKey.toString('hex'),
			address: klayr32Address,
		};
