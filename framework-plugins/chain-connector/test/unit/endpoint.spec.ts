...
import { testing, cryptography, db, chain, codec, Engine, Types, Modules } from 'klayr-sdk';
...
describe('endpoints', () => {
	...
	let endpointContext: Types.PluginEndpointContext;
				...
				validators: [
					{
						...
						bftWeight: BigInt(1),
						blsKey: cryptography.utils.getRandomBytes(
							Modules.Interoperability.BLS_PUBLIC_KEY_LENGTH,
						),
					},
					{
						address: cryptography.utils.getRandomBytes(ADDRESS_LENGTH),
