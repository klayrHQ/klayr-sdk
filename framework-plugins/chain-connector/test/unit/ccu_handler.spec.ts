...
describe('CCUHandler', () => {
	...
	let sampleLastCertificate: Modules.Interoperability.LastCertificate;
	...
	beforeEach(() => {
		...
		initArgs = {
			...
			interoperabilityMetadata: {
				...
				name: Modules.Interoperability.MODULE_NAME_INTEROPERABILITY,
			},
		};
	...
	describe('computeCCU', () => {
			...
			expect(result).toEqual({
				ccuParams: {
					...
					activeValidatorsUpdate: {
						...
						blsKeysUpdate: [],
					} as Modules.Interoperability.ActiveValidatorsUpdate,
					certificate: Modules.Interoperability.EMPTY_BYTES,
		...
		it('should throw error when no validators data was found for validators hash from last certificate', async () => {
			...
			const newCertificate: Engine.Certificate = {
		...
		it('should return valid CCU params for the new certificate with no CCMs', async () => {
			...
			expect(result).toEqual({
				ccuParams: {
					...
					activeValidatorsUpdate: {
						bftWeightsUpdate: [],
						bftWeightsUpdateBitmap: Modules.Interoperability.EMPTY_BYTES,
						blsKeysUpdate: [],
					} as Modules.Interoperability.ActiveValidatorsUpdate,
					...
					inboxUpdate: {
						...
						messageWitnessHashes,
						outboxRootWitness: {
							bitmap: Modules.Interoperability.EMPTY_BYTES,
							siblingHashes: [],
						},
					},
				},
	...
	describe('submitCCU', () => {
		...
		let ccuParams: Modules.Interoperability.CrossChainUpdateTransactionParams;
