# `pos-mainchain genesis-block`

Creates genesis block file.

- [`pos-mainchain genesis-block create`](#pos-mainchain-genesis-block-create)

## `pos-mainchain genesis-block create`

Creates genesis block file.

```
USAGE
  $ pos-mainchain genesis-block create -f <value> [-n <value>] [-c <value>] [-o <value>] [--export-json] [-h <value>] [-t
    <value>] [-p <value>]
