# `pos-mainchain transaction`

Commands relating to pos-mainchain transactions.

- [`pos-mainchain transaction create MODULE COMMAND FEE`](#pos-mainchain-transaction-create-module-command-fee)
- [`pos-mainchain transaction get ID`](#pos-mainchain-transaction-get-id)
- [`pos-mainchain transaction send TRANSACTION`](#pos-mainchain-transaction-send-transaction)
- [`pos-mainchain transaction sign TRANSACTION`](#pos-mainchain-transaction-sign-transaction)

## `pos-mainchain transaction create MODULE COMMAND FEE`

Create transaction which can be broadcasted to the network. Note: fee and amount should be in Beddows!!

```
USAGE
  $ pos-mainchain transaction create MODULE... COMMAND... FEE... [-p <value>] [-a <value>] [-j] [--send | [--offline
...
## `pos-mainchain transaction get ID`

Get transaction from local node by ID.

```
USAGE
  $ pos-mainchain transaction get ID [-d <value>] [--pretty]
...
## `pos-mainchain transaction send TRANSACTION`

Send transaction to the local node.

```
USAGE
  $ pos-mainchain transaction send TRANSACTION [-d <value>] [--pretty]
...
## `pos-mainchain transaction sign TRANSACTION`

Sign encoded transaction.

```
USAGE
  $ pos-mainchain transaction sign TRANSACTION [-p <value>] [-j] [--offline --chain-id <value>] [--mandatory-keys
