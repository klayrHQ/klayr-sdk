# `poa-sidechain transaction`

Commands relating to poa-sidechain transactions.

- [`poa-sidechain transaction create MODULE COMMAND FEE`](#poa-sidechain-transaction-create-module-command-fee)
- [`poa-sidechain transaction get ID`](#poa-sidechain-transaction-get-id)
- [`poa-sidechain transaction send TRANSACTION`](#poa-sidechain-transaction-send-transaction)
- [`poa-sidechain transaction sign TRANSACTION`](#poa-sidechain-transaction-sign-transaction)

## `poa-sidechain transaction create MODULE COMMAND FEE`

Create transaction which can be broadcasted to the network. Note: fee and amount should be in Beddows!!

```
USAGE
  $ poa-sidechain transaction create MODULE... COMMAND... FEE... [-p <value>] [-a <value>] [-j] [--send | [--offline
...
## `poa-sidechain transaction get ID`

Get transaction from local node by ID.

```
USAGE
  $ poa-sidechain transaction get ID [-d <value>] [--pretty]
...
## `poa-sidechain transaction send TRANSACTION`

Send transaction to the local node.

```
USAGE
  $ poa-sidechain transaction send TRANSACTION [-d <value>] [--pretty]
...
## `poa-sidechain transaction sign TRANSACTION`

Sign encoded transaction.

```
USAGE
  $ poa-sidechain transaction sign TRANSACTION [-p <value>] [-j] [--offline --chain-id <value>] [--mandatory-keys
