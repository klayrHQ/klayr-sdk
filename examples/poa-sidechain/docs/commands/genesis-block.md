# `poa-sidechain genesis-block`

Creates genesis block file.

- [`poa-sidechain genesis-block create`](#poa-sidechain-genesis-block-create)

## `poa-sidechain genesis-block create`

Creates genesis block file.

```
USAGE
  $ poa-sidechain genesis-block create -f <value> [-n <value>] [-c <value>] [-o <value>] [--export-json] [-h <value>] [-t
    <value>] [-p <value>]
