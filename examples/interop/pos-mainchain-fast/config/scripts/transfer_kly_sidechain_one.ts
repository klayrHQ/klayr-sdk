...
(async () => {
	...
	console.log(
		`Sent cross chain transfer transaction (amount: ${params.amount}, recipientAddress: ${recipientKLYAddress}) to send of sidechain (sendingChainID: ${params.receivingChainID}) node ${nodeAlias}. Result from transaction pool is: `,
		result,
	);
