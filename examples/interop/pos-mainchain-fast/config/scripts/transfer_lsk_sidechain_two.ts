...
(async () => {
	...
	console.log(
		`Sent cross chain transfer transaction (amount: ${params.amount}, recipientAddress: ${recipientklyAddress}) to send of sidechain (receivingChainID: ${params.receivingChainID}). Result from transaction pool is: `,
		result,
	);
