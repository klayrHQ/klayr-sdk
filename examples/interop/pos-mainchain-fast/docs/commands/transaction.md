...
```
USAGE
  $ pos-mainchain-fast transaction create [MODULE] [COMMAND] [FEE] [-p <value>] [-a <value>] [-j] [--send | [--offline
...
```
USAGE
  $ pos-mainchain-fast transaction sign [TRANSACTION] [-p <value>] [-j] [--offline --chain-id <value>]
