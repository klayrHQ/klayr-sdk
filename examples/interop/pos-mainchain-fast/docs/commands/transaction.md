# `pos-mainchain-fast transaction`

Commands relating to pos-mainchain-fast transactions.

- [`pos-mainchain-fast transaction create MODULE COMMAND FEE`](#pos-mainchain-fast-transaction-create-module-command-fee)
- [`pos-mainchain-fast transaction get ID`](#pos-mainchain-fast-transaction-get-id)
- [`pos-mainchain-fast transaction send TRANSACTION`](#pos-mainchain-fast-transaction-send-transaction)
- [`pos-mainchain-fast transaction sign TRANSACTION`](#pos-mainchain-fast-transaction-sign-transaction)

## `pos-mainchain-fast transaction create MODULE COMMAND FEE`

Create transaction which can be broadcasted to the network. Note: fee and amount should be in Beddows!!

```
USAGE
  $ pos-mainchain-fast transaction create MODULE... COMMAND... FEE... [-p <value>] [-a <value>] [-j] [--send |
...
## `pos-mainchain-fast transaction get ID`

Get transaction from local node by ID.

```
USAGE
  $ pos-mainchain-fast transaction get ID [-d <value>] [--pretty]
...
## `pos-mainchain-fast transaction send TRANSACTION`

Send transaction to the local node.

```
USAGE
  $ pos-mainchain-fast transaction send TRANSACTION [-d <value>] [--pretty]
...
## `pos-mainchain-fast transaction sign TRANSACTION`

Sign encoded transaction.

```
USAGE
  $ pos-mainchain-fast transaction sign TRANSACTION [-p <value>] [-j] [--offline --chain-id <value>] [--mandatory-keys
