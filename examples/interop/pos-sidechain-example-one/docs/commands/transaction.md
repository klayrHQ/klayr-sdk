# `pos-sidechain-example-one transaction`

Commands relating to pos-sidechain-example-one transactions.

- [`pos-sidechain-example-one transaction create MODULE COMMAND FEE`](#pos-sidechain-example-one-transaction-create-module-command-fee)
- [`pos-sidechain-example-one transaction get ID`](#pos-sidechain-example-one-transaction-get-id)
- [`pos-sidechain-example-one transaction send TRANSACTION`](#pos-sidechain-example-one-transaction-send-transaction)
- [`pos-sidechain-example-one transaction sign TRANSACTION`](#pos-sidechain-example-one-transaction-sign-transaction)

## `pos-sidechain-example-one transaction create MODULE COMMAND FEE`

Create transaction which can be broadcasted to the network. Note: fee and amount should be in Beddows!!

```
USAGE
  $ pos-sidechain-example-one transaction create [MODULE] [COMMAND] [FEE] [-p <value>] [-a <value>] [-j] [--send |
...
## `pos-sidechain-example-one transaction get ID`

Get transaction from local node by ID.

```
USAGE
  $ pos-sidechain-example-one transaction get [ID] [-d <value>] [--pretty]
...
## `pos-sidechain-example-one transaction send TRANSACTION`

Send transaction to the local node.

```
USAGE
  $ pos-sidechain-example-one transaction send [TRANSACTION] [-d <value>] [--pretty]
...
## `pos-sidechain-example-one transaction sign TRANSACTION`

Sign encoded transaction.

```
USAGE
  $ pos-sidechain-example-one transaction sign [TRANSACTION] [-p <value>] [-j] [--offline --chain-id <value>]
