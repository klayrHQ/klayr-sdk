# `pos-sidechain-example-two transaction`

Commands relating to pos-sidechain-example-two transactions.

- [`pos-sidechain-example-two transaction create MODULE COMMAND FEE`](#pos-sidechain-example-two-transaction-create-module-command-fee)
- [`pos-sidechain-example-two transaction get ID`](#pos-sidechain-example-two-transaction-get-id)
- [`pos-sidechain-example-two transaction send TRANSACTION`](#pos-sidechain-example-two-transaction-send-transaction)
- [`pos-sidechain-example-two transaction sign TRANSACTION`](#pos-sidechain-example-two-transaction-sign-transaction)

## `pos-sidechain-example-two transaction create MODULE COMMAND FEE`

Create transaction which can be broadcasted to the network. Note: fee and amount should be in Beddows!!

```
USAGE
  $ pos-sidechain-example-two transaction create [MODULE] [COMMAND] [FEE] [-p <value>] [-a <value>] [-j] [--send |
    [--offline --chain-id <value> --nonce <value>]] [--no-signature -s <value>] [-d <value>] [-k <value>] [--pretty] [-f
    <value>]
...
## `pos-sidechain-example-two transaction get ID`

Get transaction from local node by ID.

```
USAGE
  $ pos-sidechain-example-two transaction get [ID] [-d <value>] [--pretty]
...
## `pos-sidechain-example-two transaction send TRANSACTION`

Send transaction to the local node.

```
USAGE
  $ pos-sidechain-example-two transaction send [TRANSACTION] [-d <value>] [--pretty]
...
## `pos-sidechain-example-two transaction sign TRANSACTION`

Sign encoded transaction.

```
USAGE
  $ pos-sidechain-example-two transaction sign [TRANSACTION] [-p <value>] [-j] [--offline --chain-id <value>]
    [--mandatory-keys <value>] [--optional-keys <value>] [-d <value>] [-k <value>] [--pretty]
