 ...
 *
 */
import { KlayrvalidationError, validator } from '../src';
...
describe('validator keywords', () => {
	...
	const validSchema = {
		$id: '/mySchema',
		$schema: 'http://klayr.xyz/klayr-schema/schema#',
		type: 'object',
		properties: {
			myProp: {
				dataType: 'string',
						...
						validator.validate(
							{
								...validSchema,
								properties: {
									myProp: { dataType: 'bytes', fieldNumber: 1, format: 'klayr32' },
								},
							},
