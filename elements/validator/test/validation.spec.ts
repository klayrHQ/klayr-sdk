...
describe('validation', () => {
	...
	describe('#isBytes', () => {
		...
		it('should return false when string was provided', () => {
			return expect(isBytes('klayr test 12345')).toBeFalse();
		});

		it('should return true when buffer was provided', () => {
			return expect(isBytes(Buffer.from('klayr', 'utf8'))).toBeTrue();
		});
	});
	...
	describe('#isString', () => {
		...
		it('should return false when buffer was provided', () => {
			return expect(isString(Buffer.from('klayr', 'utf8'))).toBeFalse();
		});

		it('should return true when string was provided', () => {
			return expect(isString('klayr test 12345')).toBeTrue();
		});
	});
	...
	describe('#isBoolean', () => {
		...
		it('should return false when buffer was provided', () => {
			return expect(isBoolean(Buffer.from('klayr', 'utf8'))).toBeFalse();
		});

		it('should return false when string was provided', () => {
			return expect(isBoolean('klayr test 12345')).toBeFalse();
		});
	...
	describe('#isSInt32', () => {
		...
		it('should return false when buffer was provided', () => {
			return expect(isSInt32(Buffer.from('klayr', 'utf8'))).toBeFalse();
		});
	...
	describe('#isUInt32', () => {
		...
		it('should return false when buffer was provided', () => {
			return expect(isUInt32(Buffer.from('klayr', 'utf8'))).toBeFalse();
		});
	...
	describe('#isSInt64', () => {
		...
		it('should return false when buffer was provided', () => {
			return expect(isSInt64(Buffer.from('klayr', 'utf8'))).toBeFalse();
		});
	...
	describe('#isUInt64', () => {
		...
		it('should return false when buffer was provided', () => {
			return expect(isUInt64(Buffer.from('klayr', 'utf8'))).toBeFalse();
		});
