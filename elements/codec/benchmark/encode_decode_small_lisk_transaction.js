...
const transferLikeKlayrtransaction = {
...
const transferLikeKlayrtransactionEncoded = codec.encode(testSchema, transferLikeKlayrtransaction);

suite
	.add('Encode transfer like Klayr transaction', () => {
		codec.encode(testSchema, transferLikeKlayrtransaction);
	})
	.add('Decode transfer like Klayr transaction', () => {
		codec.decode(testSchema, transferLikeKlayrtransactionEncoded);
	})
