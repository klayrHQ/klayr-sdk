...
import { ed, utils } from '@klayr/cryptography';
import { codec } from '@klayr/codec';
import { validator, KlayrValidationError } from '@klayr/validator';
...
export class BlockHeader {
	...
	public validateGenesis(): void {
		...
		if (errors.length) {
			throw new KlayrValidationError(errors);
		}
	}
