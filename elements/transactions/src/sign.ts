 ...
 *  @example
 *  ```ts
 *  import { getSigningBytes } from '@klayr/transactions';
 ...
 *
 * @see [LIP 0028 - Define schema and use generic serialization for transactions](https://github.com/Klayrhq/lips/blob/main/proposals/lip-0028.md)
 * @see [LIP 0068 - Define new transaction schema](https://github.com/Klayrhq/lips/blob/main/proposals/lip-0068.md)
 * @see [LIP 0062 - Use pre-hashing for signatures](https://github.com/Klayrhq/lips/blob/main/proposals/lip-0062.md)
 */
 ...
 * @example
 *  ```ts
 *  import { getBytes } from '@klayr/transactions';
 ...
 * @example
 *  ```ts
 *  import { signTransaction } from '@klayr/transactions';
 ...
 * @example
 *  ```ts
 *  import { signTransactionWithPrivateKey } from '@klayr/transactions';
 ...
 * @example
 *  ```ts
 *  import { signMultiSignatureTransactionWithPrivateKey } from '@klayr/transactions';
